...
TEST_F(JsonCastTest, unsupportedTypes) {
  ...
  auto arrayKeyVector = makeNullableArrayVector<int64_t>(std::vector<std::vector<std::optional<int64_t>>>{{1}, {2}});
  ...
  VELOX_ASSERT_THROW(
      evaluateCast(
          MAP(ARRAY(BIGINT()), BIGINT()), JSON(), makeRowVector(std::vector<VectorPtr>{arrayKeyMap})),
...
TEST_F(JsonCastTest, toMap) {
  ...
  auto expected = makeNullableMapVector<StringView, StringView>(
      {{{{"blue"_sv, "2.2"_sv}, {"red"_sv, "1"_sv}}},
       ...
       std::make_optional<std::vector<std::pair<StringView, std::optional<StringView>>>>({}),
       std::nullopt});
  ...
  expected = makeNullableMapVector<int64_t, double>(
      {{{{101, 1.1}, {102, 2.0}}},
       ...
       std::make_optional<std::vector<std::pair<int64_t, std::optional<double>>>>({}),
       std::nullopt});
...
TEST_F(JsonCastTest, toNested) {
  ...
  auto arrayExpected = makeNullableNestedArrayVector<StringView>(
      {{{{{"1"_sv, "2"_sv}}, {{"3"_sv}}}},
       ...
       {{{{}}}},
       std::make_optional<std::vector<std::optional<std::vector<std::optional<StringView>>>>>({})});
